...
export class SchoolProfileComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder, private subservice:SubserviceService,private router:Router,private activatedRoute: ActivatedRoute) { }
    ...
    this.generalForm=this.fb.group({
      ...
      if(this.id!=null){
        if(this.status!=null){
          ...
          this.subservice.retsclprofile(this.id).subscribe((arg: any) =>{
            this.data=arg;
  ...
  onSubmit(){
    if(this.id!=null){
      ...
      if(this.generalForm.controls[dataToSubmit].valid){
        this.subservice.upsclprofile(this.generalForm.controls[dataToSubmit].value,this.id).subscribe((arg:any) => {
        console.log()
      })
       }
      else{
      ...
      if(this.generalForm.controls[dataToSubmit].valid){
        if(this.profid == null){
          ...
          this.subservice.addsclprofile(this.generalForm.controls[dataToSubmit].value).subscribe((arg:any) => {
          this.profid=arg.data;
          console.log()
        });
          ...
          this.subservice.upsclprofile(this.generalForm.controls[dataToSubmit].value,this.profid).subscribe((arg:any) => {
          console.log()
          });
        }
